<div class="container py-0" style="padding-top:0 !important; margin-top:0 !important; position:relative;">
    ...
    <div class="despacho-header d-flex align-items-center justify-content-start mb-0">
        <div class="d-flex align-items-center gap-4 flex-nowrap" style="white-space:nowrap;">
            ...
            <h2 class="fw-bold mb-0" style="color:#1a237e; letter-spacing:0.5px; font-size:1.5rem; white-space:nowrap;">Edición de Vale - Despachos Internos</h2>
        </div>
        <div class="d-flex align-items-center gap-2 ms-4">
            ...
            <div id="bloqueNumeroVale" class="bg-warning bg-gradient rounded-4 shadow-sm px-3 py-1 text-center d-flex align-items-center justify-content-center flex-nowrap d-none" style="min-width:120px; margin-left:20px; white-space:nowrap;">
                ...
                <span id="correlativoVale" class="fw-bolder" style="font-size:1.25rem; color:#1a237e; letter-spacing:2px; vertical-align:middle; white-space:nowrap;">VDI-000001</span>
            </div>
        </div>
    </div>
    ...
    <style>
        ...
        #grillaDespacho thead th:nth-child(6) {
            text-align: center !important;
        }
    ...
    <div id="cardFechaTurno" class="card shadow-sm border-0 mb-3 d-none" style="max-width:1150px; margin-left:0; margin-right:auto;">
        <div class="card-body py-3 px-3">
            <form autocomplete="off" id="formDespachoInterno">
    ...
    <!-- Card 2: Despachador, Recepcionista, Verificador -->
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="modalBuscarValeLabel"><i class="bi bi-search me-2"></i>Buscar Vale de Despacho Interno</h5>
                        ...
                        <div class="row g-2">
                            <div class="col-md-10">
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text">VDI-</span>
...
<!-- Modal de impresión (vista previa idéntica a Nuevo Registro) -->
...
<!-- Modal de confirmación para anular vale (igual que Recepciones Externas) -->
...
<script>
    ...
    window.responsablesUsernameMap = <?= json_encode($responsablesUsernameMap ?? []) ?>;
    // Bandera para evitar que el listener de despachosinternos.js (main page)
    // ejecute su flujo de guardado en esta página de edición, ya que
    // despachosinternos_edicion.js maneja su propio listener.
