    ...
    <div class="card shadow-sm border-0" style="width:100%; max-width:480px;">
        <div class="card-body p-4">
            <div class="mb-4 d-flex align-items-center">
                ...
                <div>
                    <h3 class="mb-0 fw-bold" style="letter-spacing:0.5px; color:#1a237e;">Editar Transportista</h3>
                ...
                <div class="mb-3 d-flex justify-content-center">
                    <div style="width:100%; max-width:480px; margin:0 auto;">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="text" class="form-control" id="RUC" name="RUC" value="<?= htmlspecialchars($data['RUC'] ?? '') ?>" required style="text-transform:uppercase;" oninput="this.value = this.value.toUpperCase()">
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        console.warn('No se pudo aplicar toggle Manual en edit transportistas', e);
    }
});
</script>
