    ...
    <div class="card shadow-sm border-0" style="width:100%; max-width:480px;">
        <div class="card-body p-4">
            <div class="mb-4 d-flex align-items-center">
                ...
                <h3 class="mb-0 fw-bold" style="letter-spacing:0.5px; color:#1a237e;">Agregar Recepcionista</h3>
            ...
            <?php endif; ?>
            <form method="post" action="<?= app_url('recepcionistas/store') ?>" id="formRecepcionista" autocomplete="off">
