<?php
 if (!isset($titulo)) $titulo = 'Editar Observación'; ?>
    ...
    <div class="card shadow-sm border-0" style="width:100%; max-width:480px;">
        <div class="card-body p-4">
            <div class="mb-4 d-flex align-items-center">
                <i class="bi bi-journal-text display-6 text-primary me-2"></i>
                <h3 class="mb-0 fw-bold" style="letter-spacing:0.5px; color:#1a237e;">Editar Observación</h3>
            </div>
