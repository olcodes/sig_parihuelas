    ...
    <div class="card shadow-sm border-0" style="width:100%; max-width:480px;">
        <div class="card-body p-4">
            <div class="mb-4 d-flex align-items-center">
                ...
                <div>
                    <h3 class="mb-0 fw-bold" style="letter-spacing:0.5px; color:#1a237e;">Editar Placa</h3>
            ...
            <?php endif; ?>
            <form method="post" action="<?= app_url('placas/update/' . urlencode($Id)) ?>" autocomplete="off">
                <div class="mb-3">
                ...
                <div class="d-flex justify-content-between gap-2">
                    <button type="submit" class="btn btn-primary px-4 fw-bold"><i class="bi bi-check-circle me-1"></i>Actualizar</button>
