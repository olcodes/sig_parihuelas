            ...
            <form method="post" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group" style="max-width: 300px;">
                            <input type="text" class="form-control form-control-lg" id="RUC" name="RUC" maxlength="11" style="max-width: 140px;" value="<?= htmlspecialchars($data['RUC'] ?? '') ?>" required>
...
document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        console.warn('No se pudo aplicar autocompletado RUC en edit clientes_externos', e);
    }
});
</script>
