    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="card shadow-sm mt-4">
                ...
                <div class="card-body">
                    <form method="post" action="<?= app_url('roles/store') ?>" autocomplete="off" class="needs-validation" novalidate>
                        <div class="mb-3">
 ...
 foreach ($privilegios as $p): ?>
                                    <div class="col-12 col-md-6 mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="privilegios[]" id="privilegio<?= $p['Id'] ?>" value="<?= $p['Id'] ?>">
