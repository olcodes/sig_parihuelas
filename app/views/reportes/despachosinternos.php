...
@media print {
    ...
    #print-only-container {
        ...
        /* Las esquinas redondeadas se manejan via .vale-frame en el JS */
}
</style>
...
<!-- Forzar estilo compacto para el modal de vista previa (coincidente con registro) -->
<style>
    #modalValePreview .modal-dialog { max-width: 680px !important; }
    #modalValePreview .modal-body { padding: 8px !important; font-size: 0.58rem !important; }
    #modalValePreview .modal-title { font-size: 0.9rem !important; }
    /* Ajustes internos del contenido de preview */
    #modalValePreview #valePreviewContent { font-size: 0.58rem !important; line-height:1.08 !important; }
    #modalValePreview #valePreviewContent table { font-size: 0.52rem !important; }
    #modalValePreview #valePreviewContent .productos-header td { font-size:0.52rem !important; }
    #modalValePreview #valePreviewContent img { max-height: 26px !important; }
    #modalValePreview .modal-footer .btn { padding: 6px 12px; }
</style>
<?php
?>
        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h2 class="fw-bold mb-0" style="color:#1a237e; letter-spacing:0.5px; font-size:2rem;">Reporte Despachos Internos</h2>
                </div>
                ...
                <table class="table table-hover table-bordered table-sm" id="grillaReporte" style="table-layout:auto; width:100%; border-collapse: collapse !important;">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th data-filterable="true" data-field="Emisor">Emisor</th>
            ...
            <style>
                ...
                /* Centrar los campos numéricos y de código en la grilla y en la vista previa/impresión */
                .campo-codigo,
                ...
                #grillaReporte td {
                    overflow: hidden;
                    text-overflow: ellipsis;
                    font-size: 12px !important; /* Tamaño de texto ligeramente incrementado */
                    padding: 2px 4px !important;
                    vertical-align: middle !important;
                    line-height: 1.2 !important;
                }
                /* Aplicar tamaño de texto ligeramente mayor a la tabla */
                #grillaReporteBody {
                    font-size: 12px !important;
                }
...
<script src="<?= BASE_URL ?>/js/reportes_despachosinternos.js?v=<?= time() ?>"></script>
...
<!-- OVERRIDE COMPACTO: Forzar estilos compactos al final -->
<style>
...
<!-- FORZAR RECARGA DEL SCRIPT JS (ELIMINAR CACHE) -->
<script>
    (function() {
        const timestamp = '<?php echo time(); ?>';
        const scriptSrc = window.BASE_URL + '/js/reportes_despachosinternos.js?v=' + timestamp;
        const existingScript = document.querySelector('script[src*="reportes_despachosinternos.js"]');
        if (existingScript) {
            console.log('[CACHE_BUSTER] Removiendo script viejo y recargando con timestamp:', timestamp);
            existingScript.remove();
        }
        const newScript = document.createElement('script');
        newScript.src = scriptSrc;
        newScript.onload = function() {
            console.log('[CACHE_BUSTER] Script recargado exitosamente con nueva versión');
        };
        document.head.appendChild(newScript);
    })();
</script>
<!-- DEBUG: Verificar que la vista y los scripts se cargan correctamente -->
<script>
    try {
        console.log('[DEBUG_VIEW] despachoInternos.php cargado - scripts incluidos');
        // Comprobar que el archivo JS principal está accesible
        const scriptEl = document.querySelector('script[src*="reportes_despachosinternos.js"]');
        if (!scriptEl) console.warn('[DEBUG_VIEW] No se encontró el script reportes_despachosinternos.js en el DOM');
        else console.log('[DEBUG_VIEW] script reportes_despachosinternos.js encontrado, src=', scriptEl.src);
    } catch(e) { console.error('[DEBUG_VIEW] Error comprobando scripts:', e); }
</script>
