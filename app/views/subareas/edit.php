    ...
    <div class="card shadow-sm border-0" style="width:100%; max-width:480px;">
        <div class="card-body p-4">
            <div class="mb-4 d-flex align-items-center">
                ...
                <h3 class="mb-0 fw-bold" style="letter-spacing:0.5px; color:#1a237e;">Editar Subárea</h3>
            </div>
            <?php
 if (!empty($errores)): ?>
            ...
            <form method="post" autocomplete="off">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-lg" id="Subarea" name="Subarea" maxlength="100" value="<?= htmlspecialchars($data['Subarea'] ?? '') ?>" required style="text-transform:uppercase;" oninput="this.value = this.value.toUpperCase()">
                </div>
                <div class="d-flex justify-content-between gap-2">
                    <button type="submit" class="btn btn-primary px-4 fw-bold"><i class="bi bi-save me-1"></i>Actualizar</button>
                    <a href="<?= app_url('subareas') ?>" class="btn btn-secondary px-4"><i class="bi bi-arrow-left me-1"></i>Cancelar</a>
                </div>
            </form>
        </div>
    </div>
...
<style>
    /* Asegurar que el dropdown de bootstrap-select esté por encima de otros elementos */
    .bootstrap-select .dropdown-menu {
        z-index: 2080 !important;
    }
</style>
<!-- selectpicker initialized globally in public/js/main.js -->
